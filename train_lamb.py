...
parser.add_argument("--log", type=str, help="dir of the log file", default='wikitext2_lm.log')
...
optimizer = Lamb(model.parameters(), lr=args.lr, weight_decay=args.wd, betas=(args.beta1, args.beta2), adam=(args.optimizer == 'adam'))
...
def train():
    ...
    for batch, i in enumerate(range(0, train_data.size(0) - 1, args.bptt)):
        ...
        #         rescale = torch.maximum(torch.norm(p.data) / torch.norm(p.grad), torch.tensor(1.0))
