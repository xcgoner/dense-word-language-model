...
if args.model == 'Transformer':
    ...
    model = model.RNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, args.tied, False).to(device)
        ...
        for name, p in model.named_parameters():
            if p.requires_grad:
                ...
                if batch % args.log_interval == 0 and batch > 0:
                    ...
                    print('name=%25s, ||g||=%1.6f, ||w||=%3.6f, ||w||/||g||=%06.1f' % (name, gnorm, wnorm, wnorm / gnorm))
