...
parser.add_argument('--dense-embedding-n', type=str, default="650",
...
if args.model == 'Transformer':
    model = model_mlp_embedding.TransformerModel(ntokens, args.emsize, args.nhead, args.nhid, args.nlayers, args.dropout).to(device)
else:
    dense_embedding_n = [int(emb_size) for emb_size in args.dense_embedding_n.split(',')]
    model = model_mlp_embedding.RNNModel(args.model, ntokens, args.emsize, args.nhid, args.nlayers, args.dropout, args.tied, 
                            args.dense_embedding, dense_embedding_n, args.dense_embedding_type, args.dense_embedding_initrange).to(device)
