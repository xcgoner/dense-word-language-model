...
class RNNModel(nn.Module):
    ...
    def __init__(self, rnn_type, ntoken, ninp, nhid, nlayers, dropout=0.5, tie_weights=False, 
        ...
        if dense_embedding:
            print('using %s dense embedding layer with size %d' % (dense_embedding_type, dense_embedding_n))
            ...
            if dense_embedding_type == 'random_sphere':  
                ...
                self.encoder_weight = (torch.randint(0, 2, (ntoken, dense_embedding_n)) * 2 - 1) * dense_embedding_initrange
        ...
        if dense_embedding:
            ...
            self.encoder_linear = nn.Linear(dense_embedding_n, ninp, bias=True)
        # debug
        # print(self.encoder.weight.requires_grad)
